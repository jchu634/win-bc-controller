...
import { FilePlusIcon, SpinnerGapIcon, WarningIcon } from "@phosphor-icons/react";
...
export function MacroPicker({ selected, onSelect, onCreate, refreshKey = 0 }: MacroPickerProps) {
    ...
    <section className="flex min-w-0 flex-col gap-3 text-left">
      ...
      {error !== null && (
        ...
        >
          ...
          <p className="wrap-break-words min-w-0 flex-1">{error}</p>
