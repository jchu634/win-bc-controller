...
import { SliderBuffer, SliderFill, SliderThumb, SliderTrack } from '@/src/components/videojs/ui/slider';
    ...
    >
      ...
      <TimeSliderPrimitive.Preview
        className={cn(
          ...
          'before:top-1/2 before:start-1/2 before:size-1 before:rounded-media-control before:bg-current'
        )}
        overflow={previewOverflow}
      >
        <SliderPrimitive.Thumbnail.Root
          className={cn(
            'absolute max-w-(--media-slider-preview-max-width) -translate-x-1/2 rtl:translate-x-1/2 translate-y-media-hidden-preview-offset scale-media-hidden-preview opacity-0',
        ...
        >
          ...
          <SpinnerIconPrimitive
            className={cn(
              'absolute top-1/2 start-1/2 z-10 size-media-icon -translate-x-1/2 rtl:translate-x-1/2 -translate-y-1/2 opacity-0',
        ...
        >
          <TimeSliderPrimitive.ChapterTitle
            className={cn('max-w-(--media-slider-preview-max-width) min-w-0 truncate empty:hidden', 'px-6')}
          />
