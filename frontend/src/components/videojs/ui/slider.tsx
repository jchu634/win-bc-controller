...
export function SliderThumb({ className, ...props }: SliderThumbProps) {
  return (
    <div
      className={cn(
        'absolute z-10 top-1/2 start-(--media-slider-fill) size-3 -translate-x-1/2 rtl:translate-x-1/2 -translate-y-1/2 rounded-media-control bg-white',
        ...
        'data-[orientation=vertical]:top-[calc(100%-var(--media-slider-fill))] data-[orientation=vertical]:start-1/2',
